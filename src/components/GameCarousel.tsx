...
const gameData = [
  {
    ...
    bgImage: "bg-[url(/images/LavaBG.png)]",
  },
  {
    id: 2,
    ...
    bgImage: "bg-[url(/images/BlueBG.png)]",
  },
  {
    id: 3,
    ...
    bgImage: "bg-[url(/images/SupportBG.png)]",
  },
  {
    id: 4,
    ...
    bgImage: "bg-[url(/images/TacticianBG.png)]",
  },
  {
    id: 5,
    ...
    bgImage: "bg-[url(/images/SpecialistBG.png)]",
  },
];
...
export default function GameCarousel() {
  ...
  return (
    ...
    >
      <div className={`w-full lg:w-2/5 z-20 absolute -top-40`}>
        <Carousel
          setApi={setApi}
        ...
        >
          <CarouselContent className="">
            {gameData.map((game, index) => (
              <CarouselItem key={game.id} className={`max-h-[800px]`}>
                <div
                  className={`w-full h-full flex rounded-2xl ${game.bgImage} bg-center`}
                >
          ...
          <CarouselPrevious
            ...
            className={`left-1 md:left-6 p-1 absolute ${gameData[getPrev(currentCard)].hex} bg-bottom-right cursor-pointer hover:border hover:border-4 hover:border-black size-12 md:size-22`}
            variant="ghost"
          />
          <CarouselNext
            image={gameData[getNext(currentCard)].classIconRight}
            className={`right-1 md:right-6 p-1 absolute ${gameData[getNext(currentCard)].hex} cursor-pointer hover:border hover:border-4 hover:border-black size-12 md:size-22`}
            variant="ghost"
          />
        </Carousel>
      </div>
